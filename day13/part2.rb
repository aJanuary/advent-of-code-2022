...
packets_with_dividers = packets.flatten(1) + DIVIDERS
sorted = packets_with_dividers.sort {|a, b| compare_list(a, b)}
divider_indices = DIVIDERS.map {|divider| sorted.index(divider) + 1}

puts divider_indices.inject(:*)